...
class LevelTwo extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.image("carangueijo", "assets/FASE 2 IMAGENS/carangueijo.png");
    ...
    //Instruções
    this.load.image("besouroInst", "assets/FASE 2 IMAGENS/besouroInst.png");
    this.load.image(
      "carangueijoInst",
      "assets/FASE 2 IMAGENS/caranguejoInst.png"
    );
    this.load.image("latinha1Inst", "assets/FASE 2 IMAGENS/latinha1Inst.png");
    this.load.image("latinha2Inst", "assets/FASE 2 IMAGENS/latinha2Inst.png");
    this.load.image(
      "instructions",
    ...
    this.load.image("curriculoInst", "assets/FASE 2 IMAGENS/curriculoInst.png");
    this.load.image("recursosInst", "assets/FASE 2 IMAGENS/recursosInst.png");
    this.load.image("suporteInst", "assets/FASE 2 IMAGENS/suporteInst.png");

    //Botões
    this.load.image("btnConfirma", "assets/FASE 2 IMAGENS/btnConfirma.png");
    ...
    this.load.audio(
      "fxAbriuObjeto",
      "assets/gameAssets/Audio/sounds/soundEffects/Fase2/fxAbriuObjeto.mp3"
    );
    this.load.audio(
      "fxAreiaMexendo",
      "assets/gameAssets/Audio/sounds/soundEffects/Fase2/fxAreiaMexendo.mp3"
    );
    this.load.audio(
      "fxCorreto",
      "assets/gameAssets/Audio/sounds/soundEffects/Reutilizaveis/fxCorreto.mp3"
    );
    this.load.audio(
      "fxErrado",
      "assets/gameAssets/Audio/sounds/soundEffects/Reutilizaveis/fxErrado.mp3"
    );
    this.load.audio(
      "fxFaseCompleta",
  ...
  create() {
    ...
    this.fxAbriuObjeto = this.sound.add("fxAbriuObjeto");
    this.fxAreiaMexendo = this.sound.add("fxAreiaMexendo");
    this.fxCorreto = this.sound.add("fxCorreto");
    this.fxErrado = this.sound.add("fxErrado");
  ...
  variavel = cena.add
    ...
    .on("pointerdown", () => {
      ...
      if (variavel.alpha >= 0.7) {
        ...
        cena.fxAbriuObjeto.play();
        createObjectView(cena, util, nome);
      }
    });
}

//Função de criar a tela de descrição do objeto, com função de confirmar e de deletar
...
//Função de criar botão de finalização da fase
function createEndButton(cena) {
  cena.add
    ...
    .on("pointerdown", () => {
      ...
      cena.fxFaseCompleta.play();
    });
}
//Função de criar tela de instruções da fase
