...
class LevelThree extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.audio("fxConectouFio", "assets/gameAssets/Audio/sounds/soundEffects/Fase3/fxConectouFio.mp3");
    this.load.audio("fxEntraServidor", "assets/gameAssets/Audio/sounds/soundEffects/Fase3/fxEntraServidor.mp3");
    this.load.audio("fxTVLigou", "assets/gameAssets/Audio/sounds/soundEffects/Fase3/fxTVLigou.mp3");
    this.load.audio("fxCorreto", "assets/gameAssets/Audio/sounds/soundEffects/Reutilizaveis/fxCorreto.mp3");
    this.load.audio("fxErrado", "assets/gameAssets/Audio/sounds/soundEffects/Reutilizaveis/fxErrado.mp3");
    this.load.audio("fxFaseCompleta", "assets/gameAssets/Audio/sounds/soundEffects/Reutilizaveis/fxFaseCompleta.mp3");
  ...
  create() {
    ...
    this.fxConectouFio = this.sound.add("fxConectouFio");
    this.fxEntraServidor = this.sound.add("fxEntraServidor");
    this.fxTVLigou = this.sound.add("fxTVLigou");
